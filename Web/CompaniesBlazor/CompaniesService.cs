...
public class CompaniesService
{
        ...
        int pageNumber, int pageSize)
    {
        ...
        var request = new HttpRequestMessage(HttpMethod.Post, "api/elastic-search-customer")
        {
    ...
    public async Task<string[]> GetSuggestedCustomersAsync(string? searchText)
    {
        ...
        var request = new HttpRequestMessage(HttpMethod.Post, "api/elastic-suggest-customer")
        {
            Content = JsonContent.Create(requestBody)
        };
        var response = await _httpClient.SendAsync(request);
    ...
    public async Task<SearchCompanyResponse?> GetCompaniesAsync()
    {
        ...
        var request = new HttpRequestMessage(HttpMethod.Post, "api/elastic-search-company")
        {
            Content = JsonContent.Create(requestBody)
        };
        var response = await _httpClient.SendAsync(request);
